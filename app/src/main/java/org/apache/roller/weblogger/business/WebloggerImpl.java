...
public abstract class WebloggerImpl implements Weblogger {
    ...
    private final BugReportNotificationService bugReportNotificationService;
    ...
    protected WebloggerImpl(
        ...
        BugReportNotificationService bugReportNotificationService) throws WebloggerException { 
        ...
        this.getBugReportManager    = getBugReportManager;
        this.bugReportNotificationService = bugReportNotificationService;
    ...
    public BugReportManager getBugReportManager() {
        return this.getBugReportManager;
    }

    @Override
    public BugReportNotificationService getBugReportNotificationService() {
        return this.bugReportNotificationService;
    }
