        ...
        if (!hasActionErrors()) {
            try {
                ...
                if (stylesheet.getTemplateRendition(RenditionType.STANDARD) != null) {
                    ...
                    CustomTemplateRendition tc = (CustomTemplateRendition) stylesheet.getTemplateRendition(RenditionType.STANDARD);
                ...
                if (stylesheet.getTemplateRendition(RenditionType.MOBILE) != null) {
                    CustomTemplateRendition tc = (CustomTemplateRendition) stylesheet.getTemplateRendition(RenditionType.MOBILE);
            ...
            try {
                ...
                if (stylesheet.getTemplateRendition(RenditionType.STANDARD) != null) {
                    ...
                    CustomTemplateRendition existingTemplateCode =
                        (CustomTemplateRendition) stylesheet.getTemplateRendition(RenditionType.STANDARD);
                ...
                if (stylesheet.getTemplateRendition(RenditionType.MOBILE) != null) {
                    ...
                    CustomTemplateRendition existingTemplateCode =
                        (CustomTemplateRendition) stylesheet.getTemplateRendition(RenditionType.MOBILE);
