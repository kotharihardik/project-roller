...
import org.apache.roller.weblogger.business.dashboard.DashboardServiceImpl;
...
import org.apache.roller.weblogger.business.notification.BugReportNotificationServiceImpl;
...
public class JPAWebloggerModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        binder.bind(StarService.class).to(         JPAStarServiceImpl.class);

        binder.bind(BugReportManager.class).to(    JPABugReportManagerImpl.class);
        binder.bind(BugReportNotificationService.class).to(BugReportNotificationServiceImpl.class).in(com.google.inject.Singleton.class);
        binder.bind(DashboardService.class).to(    DashboardServiceImpl.class);
    }
