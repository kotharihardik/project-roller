...
public class SearchResultsPager implements WeblogEntriesPager {
    ...
    // url strategy
    final SearchURLStrategy urlStrategy;
    ...
    public SearchResultsPager(SearchURLStrategy strat, WeblogSearchRequest searchRequest, Map<Date, Set<WeblogEntryWrapper>> entries, boolean more) {
