...
import org.apache.roller.weblogger.business.search.PaginationInfo;
...
public class SearchResultsModel extends PageModel {
	...
	// pagination information encapsulated in value object
	...
	public void init(Map<String, Object> initData) throws WebloggerException {
		...
		if (searchRequest.getQuery() == null) {
			paginationInfo = new PaginationInfo(0, 0, 0);
		...
		try {
			...
			paginationInfo = searchResultList.getPaginationInfo();
		...
		pager = new SearchResultsPager(
			urlStrategy, searchRequest, results, paginationInfo.hasMoreResults());
	}
	...
	public int getOffset() {
		return paginationInfo != null ? paginationInfo.getOffset() : 0;
	}

	public int getLimit() {
		return paginationInfo != null ? paginationInfo.getLimit() : 0;
	}
