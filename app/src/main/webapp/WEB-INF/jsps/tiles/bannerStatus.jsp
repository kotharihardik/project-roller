...
<%-- Support dropdown: always visible to all logged-in users --%>
            <s:if test="authenticatedUser != null">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                           role="button" aria-haspopup="true" aria-expanded="false">
                            <s:text name="tabbedmenu.support"/> <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<s:url namespace='/roller-ui' action='bugReport'/>">
                                    <s:text name="bugReport.nav.submit"/>
                                </a>
                            </li>
                            <li>
                                <a href="<s:url namespace='/roller-ui' action='bugReportList'/>">
                                    <s:text name="bugReport.nav.list"/>
                                </a>
                            </li>
                        </ul>
                    </li>
