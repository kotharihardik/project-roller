...
<%-- ============================================================= --%>
<%-- Discussion Overview panel (only for entry-specific views)   --%>
...
<div class="panel panel-default" style="margin-bottom:16px;">
    <div class="panel-heading" style="background:#f5f5f5;">
        <strong>Discussion Overview</strong>
        <span style="color:#888; font-size:0.9em; margin-left:8px;">
            &mdash; <s:property value="discussionOverview.totalComments"/> comment(s) analysed
        </span>
    </div>
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <table class="table table-condensed" style="font-size:0.9em;">
                    <tr>
                        ...
                        <td><strong><s:property value="discussionOverview.totalComments"/></strong></td>
                    </tr>
                    <tr>
                        <td>Avg comments/day</td>
                        <td><strong><s:property value="discussionOverview.avgCommentsPerDay"/></strong></td>
                    </tr>
                    <tr>
                        <td>Activity</td>
                        <td>
                            <s:if test="discussionOverview.activityLabel == 'Very Active'">
                                <span class="label label-danger"><s:property value="discussionOverview.activityLabel"/></span>
                            </s:if>
                            <s:elseif test="discussionOverview.activityLabel == 'Moderately Active'">
                                <span class="label label-warning"><s:property value="discussionOverview.activityLabel"/></span>
                            </s:elseif>
                            <s:elseif test="discussionOverview.activityLabel == 'Quiet'">
                                <span class="label label-info"><s:property value="discussionOverview.activityLabel"/></span>
                            </s:elseif>
                            <s:else>
                                <span class="label label-default"><s:property value="discussionOverview.activityLabel"/></span>
                            </s:else>
                        </td>
                    </tr>
                </table>
            ...
            <div class="col-sm-4">
                ...
                <s:if test="discussionOverview.totalComments > 0">
                    <table class="table table-condensed" style="font-size:0.9em;">
                    ...
                    <p style="font-size:0.85em;color:#666;">
                        Dominant type:
                        <strong><s:property value="discussionOverview.dominantType"/></strong>
                    </p>
                </s:if>
            </div>
...
<%-- ============================================================= --%>
<%-- Conversation Breakdown panel (entry-specific views only)      --%>
<%-- ============================================================= --%>
...
<div class="panel panel-default" style="margin-bottom:16px;">
    <div class="panel-heading" style="background:#f5f5f5;">
        ...
        <span style="color:#888; font-size:0.9em; margin-left:8px;">
            &mdash; grouped summary of reader discussion
        </span>
    </div>
    <div class="panel-body">
        <p style="font-size:0.9em; color:#555; margin-bottom:10px;">
            Identify major themes and get a short recap of what readers are discussing.
        </p>
        <button id="btn-breakdown-keyword"
                class="btn btn-default btn-sm"
                data-entry-id="<s:property value="queryEntry.id"/>">
            Fast Breakdown (Keyword)
        </button>
        &nbsp;
        <button id="btn-breakdown-gemini"
...
<%-- Result panel — initially hidden, filled dynamically by breakdown.js --%>
<div id="breakdown-panel" class="panel panel-info" style="margin-bottom:16px; display:none;">
    <div class="panel-heading">
        <strong>Breakdown Results</strong>
    </div>
    <div class="panel-body" id="breakdown-content">
    </div>
</div>
